...
### Added
- Four-layer structure: `core/` (identity), `stack/` (machine & tooling),
  `taste/` (voice, code style, naming, sample corpus), `workflows/`
  (agent bootstrap, project setup, work management).
- `workflows/agents-init.md` — the bootstrap spec any runtime follows to find
...
- MIT `license`.
- Neutral demonstration corpus under `taste/corpus/` (creative, doc, post, email)
  and a showcase voice guide in `taste/writing-style.md`.
